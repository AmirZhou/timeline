        ...
        <div className="p-6 space-y-6">
          ...
          <div className={`rounded-lg border p-4 ${statusDetails.bgColor}`}>
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className={`font-semibold ${statusDetails.color} text-lg`}>
          ...
          {task.properties.description && (
            <div>
              <h3 className="font-semibold text-gray-900 text-lg mb-3">📝 Task Description</h3>
          ...
          <div>
            <h3 className="font-semibold text-gray-900 text-lg mb-3">🎯 Priority Information</h3>
            <div className="bg-gray-50 rounded-lg p-4 border space-y-2">
              <p className="text-gray-700">
                <span className="font-medium">Level:</span> {priorityDetails.description}
              </p>
              <p className="text-gray-700">
                <span className="font-medium">Impact:</span> {priorityDetails.impact}
              </p>
            </div>
          </div>
          ...
          {/* Timeline Section */}
          <div>
            <h3 className="font-semibold text-gray-900 text-lg mb-3">📅 Timeline Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-blue-600 font-medium">📍 Scheduled Week</span>
                </div>
                <p className="text-lg font-bold text-blue-700">Week {task.properties.week}</p>
              </div>
              
              <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-green-600 font-medium">🏗️ Project Phase</span>
                </div>
                <p className="text-sm font-semibold text-green-700">{task.properties.phase}</p>
              </div>
            </div>
          </div>
          ...
          <div>
            <h3 className="font-semibold text-gray-900 text-lg mb-3">🔗 References</h3>
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border">
                <div>
                  <span className="text-sm font-medium text-gray-600">Task ID:</span>
                  <span className="ml-2 font-mono text-sm text-gray-800">{task._id}</span>
                </div>
                <button
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="font-medium text-blue-700">View in Notion</span>
                    <p className="text-sm text-blue-600">Open the full task details in Notion workspace</p>
                  </div>
                </div>
                <svg className="w-5 h-5 text-blue-600 group-hover:text-blue-800 transition-colors" fill="currentColor" viewBox="0 0 12 12">
